...
$(document).on('click', "#no", function(event){
	window.location.href = 'http://localhost:8080/RI601-projekat-aminajukic-lejlahrustic/admin/users';
  	...
  	<div class="modal-dialog" role="document">
    	<div class="modal-content">
      		...
      		<div class="modal-body">
      		     ...
      		     <p style ="font-size:20px; color:indianred;">Are you sure you want to delete user named: <%=userName%> ?</p>
      		     </div>
      		  <form method="post" >
