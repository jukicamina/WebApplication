...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.4.1/semantic.css">	
		...
		<header class="pagetitle" style="padding:10px">
			<nav>
...
<div class="ui form error">
    ...
    <main style="width:32%; text-align:center; margin-top:10%;">
 	<h1 class="ui header" style="color:bisque; font-size: 30px;">Welcome to editors page</h1>
		<a href='/RI601-projekat-aminajukic-lejlahrustic/editor/quizzes'>	
		<button style="color:indianred; font-size:25px; font-weight:bold; font-family: 'Lucida Console', 'Courier New', monospace;" type="button" class="btn mybutton"><i class="fitted tasks icon"></i> Quiz managing</button></a>	
		<p id="err">${err}</p>
		</main>
	</form>
	</div>
