...
<html>
	...
	<body>
		...
		<nav>
				<button class="ui massive animated button" tabindex="0" onclick="location.href='/RI601-projekat-aminajukic-lejlahrustic/editor/quizzes'"
			...
			<button class="ui massive animated button" tabindex="0" onclick="location.href='/RI601-projekat-aminajukic-lejlahrustic/home'"
				style="color:indianred; background:#f5deb8;">
