...
/**
 * Servlet implementation class AddEditQuizController
 */
@WebServlet(name = "rest/admin/quizzes/*", urlPatterns = { "/rest/admin/quizzes/*" })
public class AddEditQuizController extends HttpServlet {
