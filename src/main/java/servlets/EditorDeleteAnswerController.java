...
/**
 * Servlet implementation class EditorDeleteAnswerController
 */
@WebServlet(name = "rest/editor/answers/*", urlPatterns = { "/rest/editor/answers/*" })
public class EditorDeleteAnswerController extends HttpServlet {
     ...
     */
    public EditorDeleteAnswerController() {
